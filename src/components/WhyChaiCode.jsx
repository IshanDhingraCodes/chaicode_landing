...
const WhyChaiCode = () => {
  return (
    <section className="my-12 sm:my-16 md:my-24 lg:my-40 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      {/* But Why */}
      <div className="col-span-1 sm:col-span-2 lg:col-span-2 min-h-[200px] sm:min-h-[280px] flex flex-col items-center justify-center gap-4 sm:gap-5 p-4">
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold leading-snug">
          But Why{" "}
          <span className="text-gradient text-4xl lg:text-6xl">ChaiCode</span> ?
        </h1>
      ...
      {/* About */}
      <div className="col-span-1 sm:col-span-2 lg:col-span-4 bg-orange-gradient rounded-3xl p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 items-center min-h-[200px] sm:min-h-[280px] shadow-lg">
        ...
        <div className="space-y-3 sm:space-y-4 text-center">
          ...
          <p className="text-black/80 text-xs sm:text-sm md:text-base text-justify">
