...
const WhyChaiCode = () => {
  return (
    <>
      <GradientSeparator />
      <section
        className="mb-12 -mt-28 lg:-mt-10 sm:mb-16 md:mb-24 lg:mb-40 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
