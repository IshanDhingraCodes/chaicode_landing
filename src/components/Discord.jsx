...
const Discord = () => {
  ...
  return (
    <>
      <GradientSeparator />
      <section className="flex lg:flex-row flex-col px-4 md:px-10 -mb-15 md:mb-20 -mt-10 gap-10 overflow-hidden">
        <motion.div
        ...
        >
          <p
            className={`inline-flex py-2 px-4 rounded-full tracking-wider font-semibold ${
              theme === "light-theme"
          ...
          <h2
            className="text-4xl lg:text-5xl md:leading-15 lg:leading-[55px] font-semibold text-center lg:text-start"
            aria-label="Join our community where creativity thrives"
          >
        ...
        >
          ...
          >
            <img
              src={discord}
              alt="Illustration representing our active Discord community"
              loading="lazy"
