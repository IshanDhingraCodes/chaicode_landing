    ...
    <section className="my-20">
      <div className="flex flex-col md:flex-row items-center justify- h-full w-full gap-10">
        <div className="w-full h-full">
          <img src={youtube} alt="hitesh-youtube" className="max-h-[600px]" />
        </div>

        <div className="w-full h-full flex flex-col items-center justify-center gap-5">
          {youtubeCard.map((card, i) => (
            <div
              className={`w-full h-full flex flex-col items-start justify-center gap-3 p-4 rounded-2xl ${theme === "light-theme" ? "bg-[#f0f0f0] shadow-lg border border-slate-200" : "bg-black-gradient-2"}`}
              key={i}
            >
              {/* heading */}
              <div className="flex items-center justify-center gap-6">
                <div className={`bg-orange-gradient p-2 rounded-full`}>
                  <svg
              ...
              <div className="flex items-center justify-center gap-3">
                <p
                  className={`p-2 rounded-full text-sm text-light ${theme === "light-theme" ? "bg-[#f8f8f8] shadow-lg border border-slate-200" : "bg-slate-800"}`}
                >
